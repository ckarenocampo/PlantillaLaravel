...
$jscomp.polyfillIsolated = function (k, y, z, q) {
    ...
    null != y &&
        (k
            ? $jscomp.defineProperty($jscomp.polyfills, G, { configurable: !0, writable: !0, value: y })
            : y !== z &&
              ...
              $jscomp.defineProperty(q, G, { configurable: !0, writable: !0, value: y })));
};
$jscomp.polyfill(
...
(function (k) {
    ...
    function Ab(a) {
        if (!u.__browser) {
            ...
            u.__browser = b;
            var c = k("<div/>")
                    .css({ position: "fixed", top: 0, left: -1 * k(y).scrollLeft(), height: 1, width: 1, overflow: "hidden" })
                    .append(
                        k("<div/>")
        ...
        var b = function (c, d, f) {
            ...
            for (var g, h, l = 0, n = f.length - 1; l < n; l++) {
                ...
                if (g) {
                    ...
                    e.splice(0, l + 1);
                    g = e.join(".");
                    if (Array.isArray(d)) for (h = 0, n = d.length; h < n; h++) (e = {}), b(e, d[h], g), c[f[l]].push(e);
                    else c[f[l]] = d;
                    return;
                }
    ...
    function $a(a, b, c, d) {
        ...
        var p = function (x, r) {
            ...
            t = function (x) {
                if (c === q || c === h)
                    (g = n[h]), (l = x.innerHTML.trim()), g && g._bAttrSrc ? (da(g.mData._)(d, l), p(g.mData.sort, x), p(g.mData.type, x), p(g.mData.filter, x)) : m ? (g._setter || (g._setter = da(g.mData)), g._setter(d, l)) : (d[h] = l);
                h++;
            };
        if (e)
            for (; e; ) {
    ...
    function fa(a) {
        ...
        if (-1 !== k.inArray(!1, b)) U(a, !1);
            ...
            if (0 !== l.length)
                ...
                (c = e.sZeroRecords),
                    1 == a.iDraw && "ajax" == P(a) ? (c = e.sLoadingRecords) : e.sEmptyTable && 0 === a.fnRecordsTotal() && (c = e.sEmptyTable),
                    (b[0] = k("<tr/>", { class: f ? d[0] : "" }).append(k("<td />", { valign: "top", colSpan: na(a), class: a.oClasses.sRowEmpty }).html(c))[0]);
        ...
        for (f = b.length; e < f; e++) {
            ...
            for (c = g.firstChild; c; ) {
                if ("TD" == c.nodeName.toUpperCase() || "TH" == c.nodeName.toUpperCase()) {
                    ...
                    var m = n;
                    var p = 1 === h ? !0 : !1;
                    for (d = 0; d < h; d++) for (n = 0; n < l; n++) (a[e + n][m + d] = { cell: c, unique: p }), (a[e + n].nTr = g);
                }
                c = c.nextSibling;
            }
        }
    ...
    function Ob(a) {
        ...
        m("iDisplayStart", l);
        m("iDisplayLength", n);
        var p = { draw: a.iDraw, columns: [], order: [], start: l, length: n, search: { value: f.sSearch, regex: f.bRegex } };
        for (l = 0; l < c; l++) {
            var t = b[l];
            var v = e[l];
    ...
    function Jb(a) {
        ...
        var l = function () {
            ...
            m != f.sSearch && (ya(a, { sSearch: m, bRegex: f.bRegex, bSmart: f.bSmart, bCaseInsensitive: f.bCaseInsensitive }), (a._iDisplayStart = 0), fa(a));
        };
    ...
    function Mb(a) {
        ...
        c || (a.aoDrawCallback.push({ fn: Wb, sName: "information" }), d.attr("role", "status").attr("aria-live", "polite"), k(a.nTable).attr("aria-describedby", b + "_info"));
        return d[0];
    }
    function Wb(a) {
    ...
    function Ib(a) {
        ...
        for (var g = 0, h = e.length; g < h; g++) f[0][g] = new Option("number" === typeof d[g] ? a.fnFormatNumber(d[g]) : d[g], e[g]);
    ...
    function Kb(a) {
        return k("<div/>", { id: a.aanFeatures.r ? null : a.sTableId + "_processing", class: a.oClasses.sProcessing })
    ...
    function Ea(a) {
        ...
        if (a.scrollBarVis !== ha && a.scrollBarVis !== q) (a.scrollBarVis = ha), ra(a);
            ...
            e = r.outerWidth();
            "" === c
                ? ((E.width = "100%"), M && (r.find("tbody").height() > h.offsetHeight || "scroll" == m.css("overflow-y")) && (E.width = K(r.outerWidth() - b)), (e = r.outerWidth()))
            ...
            r.outerWidth() < e
                ? ((la = h.scrollHeight > h.offsetHeight || "scroll" == m.css("overflow-y") ? e + b : e),
                  M && (h.scrollHeight > h.offsetHeight || "scroll" == m.css("overflow-y")) && (E.width = K(la - b)),
    ...
    function Xa(a) {
        ...
        if (d || (!t && !e && !f && h == na(a) && h == n.length)) for (v = 0; v < h; v++) (l = sa(a, v)), null !== l && (c[l].sWidth = K(n.eq(v).width()));
        else {
            ...
            for (v = 0; v < l.length; v++)
                (r = c[l[v]]),
                    (n[v].style.width = null !== r.sWidthOrig && "" !== r.sWidthOrig ? K(r.sWidthOrig) : ""),
                    r.sWidthOrig && e && k(n[v]).append(k("<div/>").css({ width: r.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 }));
            ...
            r = k("<div/>")
                .css(e || f ? { position: "absolute", top: 0, left: 0, height: 1, right: 0, overflow: "hidden" } : {})
                .append(h)
                .appendTo(p);
            ...
            for (v = f = 0; v < l.length; v++) (p = k(n[v])), (g = p.outerWidth() - p.width()), (p = x.bBounding ? Math.ceil(n[v].getBoundingClientRect().width) : p.outerWidth()), (f += p), (c[l[v]].sWidth = K(p - g));
            b.style.width = K(f);
            r.remove();
        }
        m && (b.style.width = K(m));
    ...
    function pa(a) {
        ...
        for (a = 0; a < e.length; a++) {
            ...
            for (f = g.length; d < f; d++) {
                ...
                b.push({ src: h, col: l, dir: e[a][1], index: e[a]._idx, type: n, formatter: u.ext.type.order[n + "-pre"] });
            }
        }
        return b;
    }
    ...
    function cc(a) {
        ...
        for (var d = 0, f = b.length; d < f; d++) {
            ...
            e.bSortable &&
                (0 < c.length && c[0].col == d ? (l.setAttribute("aria-sort", "asc" == c[0].dir ? "ascending" : "descending"), (e = g[c[0].index + 1] || g[0])) : (e = g[0]), (h += "asc" === e ? a.sSortAscending : a.sSortDescending));
    ...
    function nb(a, b, c, d) {
        ...
        c && a.oFeatures.bSortMulti
            ? ((c = k.inArray(b, T(f, "0"))), -1 !== c ? ((b = g(f[c], !0)), null === b && 1 === f.length && (b = 0), null === b ? f.splice(c, 1) : ((f[c][1] = e[b]), (f[c]._idx = b))) : (f.push([b, e[0], 0]), (f[f.length - 1]._idx = 0)))
            : f.length && f[0][0] == b
    ...
    var u = function (a) {
            ...
            this.each(function () {
                ...
                if ("table" != this.nodeName.toLowerCase()) aa(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    var r = k.extend(!0, {}, u.models.oSettings, { sDestroyWidth: p[0].style.width, sInstance: e, sTableId: e });
                    r.nTable = this;
                    r.oApi = b.internal;
                    r.oInit = g;
                    t.push(r);
                    ...
                    if (null === g.aoColumns) for (t = [], h = 0, l = e.length; h < l; h++) t.push(null);
                    else t = g.aoColumns;
                    h = 0;
                        ...
                        k(H[0])
                            ...
                            .each(function (C, B) {
                                ...
                                if (ba.mData === C) {
                                    ...
                                    if (null !== X || null !== B) (ba.mData = { _: C + ".display", sort: null !== X ? C + ".@data-" + X : q, type: null !== X ? C + ".@data-" + X : q, filter: null !== B ? C + ".@data-" + B : q }), Da(r, C);
                                }
                            });
                    }
                    var M = r.oFeatures;
                    e = function () {
                        ...
                        if (g.aaData) for (h = 0; h < g.aaData.length; h++) ea(r, g.aaData[h]);
        ...
        iterator: function (a, b, c, d) {
            ...
            for (e = h.length; m < e; m++) {
                ...
                if ("table" === b) {
                    ...
                    t !== q && f.push(t);
                } else if ("columns" === b || "rows" === b) (t = c.call(p, h[m], this[m], m)), t !== q && f.push(t);
    ...
    D.register = w = function (a, b) {
        if (Array.isArray(a)) for (var c = 0, d = a.length; c < d; c++) D.register(a[c], b);
        else {
            d = a.split(".");
            var f = mc,
                e;
    ...
    w("page.info()", function (a) {
        ...
        var b = a._iDisplayStart,
            ...
            f = -1 === c;
        return { page: f ? 0 : Math.floor(b / c), pages: f ? 1 : Math.ceil(d / c), start: b, end: a.fnDisplayEnd(), length: c, recordsTotal: a.fnRecordsTotal(), recordsDisplay: d, serverSide: "ssp" === P(a) };
    });
    ...
    var tb = function (a, b, c, d, f) {
            ...
            for (h = b.length; n < h; n++) {
                ...
                var p = 0;
                for (l = m.length; p < l; p++) (g = c("string" === typeof m[p] ? m[p].trim() : m[p])) && g.length && (e = e.concat(g));
            }
            a = L.selector[a];
        ...
        Ua = function (a, b) {
            ...
            else if ("index" == g || "original" == g) for (g = 0, a = a.aoData.length; g < a; g++) "none" == e ? c.push(g) : ((f = k.inArray(g, d)), ((-1 === f && "removed" == e) || (0 <= f && "applied" == e)) && c.push(g));
            return c;
        },
        wc = function (a, b, c) {
            var d;
    ...
    var xc = function (a, b, c, d) {
            var f = [],
                e = function (g, h) {
                    if (Array.isArray(g) || g instanceof k) for (var l = 0, n = g.length; l < n; l++) e(g[l], h);
        ...
        return tb(
            ...
            function (r) {
                ...
                if (null === r || r === q || A) {
                    n = [];
                    m = 0;
                    for (p = f.length; m < p; m++) for (h = f[m], t = 0; t < l; t++) (v = { row: h, column: t }), A ? ((x = d[h]), r(v, S(a, h, t), x.anCells ? x.anCells[t] : null) && n.push(v)) : n.push(v);
                    return n;
                }
    ...
    w("cells()", function (a, b, c) {
        ...
        d = this.iterator(
            ...
            function (m, p) {
                m = [];
                g = 0;
                for (h = e[p].length; g < h; g++) for (l = 0, n = f[p].length; l < n; l++) m.push({ row: e[p][g], column: f[p][l] });
                return m;
            },
            1
        );
    ...
    w("search()", function (a, b, c, d) {
        ...
        return a === q
            ...
            : this.iterator("table", function (e) {
                  e.oFeatures.bFilter && ya(e, k.extend({}, e.oPreviousSearch, { sSearch: a + "", bRegex: null === b ? !1 : b, bSmart: null === c ? !0 : c, bCaseInsensitive: null === d ? !0 : d }), 1);
              });
    });
    J("columns().search()", "column().search()", function (a, b, c, d) {
        return this.iterator("column", function (f, e) {
            ...
            f.oFeatures.bFilter && (k.extend(g[e], { sSearch: a + "", bRegex: null === b ? !1 : b, bSmart: null === c ? !0 : c, bCaseInsensitive: null === d ? !0 : d }), ya(f, f.oPreviousSearch, 1));
        });
    });
    w("state()", function () {
    ...
    u.defaults = {
        ...
        oClasses: {},
        oLanguage: {
            oAria: { sSortAscending: ": Activar para ordenar columnas ascendentemente", sSortDescending: ": Activar para ordenar columnas descendentemente" },
            ...
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "Ningún valor encontrado",
        },
                    ...
                    t = function (x, r) {
                        ...
                        for (A = r.length; W < A; W++) {
                            ...
                            if (Array.isArray(M)) {
                                ...
                                null !== n &&
                                    ((C = k("<a>", { class: g.sPageButton + " " + m, "aria-controls": a.sTableId, "aria-label": l[M], "data-dt-idx": p, tabindex: C, id: 0 === c && "string" === typeof M ? a.sTableId + "_" + M : null })
                                        .html(n)
                                        .appendTo(x)),
                                    ob(C, { action: M }, H),
                                    p++);
        ...
        header: {
            ...
            jqueryui: function (a, b, c, d) {
                ...
                k(a.nTable).on("order.dt.DT", function (f, e, g, h) {
                    a === e &&
                        ((f = c.idx),
                        b.removeClass(d.sSortAsc + " " + d.sSortDesc).addClass("asc" == h[f] ? d.sSortAsc : "desc" == h[f] ? d.sSortDesc : c.sSortingClass),
                        b
                            .find("span." + d.sSortIcon)
                            .removeClass(d.sSortJUIAsc + " " + d.sSortJUIDesc + " " + d.sSortJUI + " " + d.sSortJUIAscAllowed + " " + d.sSortJUIDescAllowed)
                            .addClass("asc" == h[f] ? d.sSortJUIAsc : "desc" == h[f] ? d.sSortJUIDesc : c.sSortingClassJUI));
                });
            },
        },
    });
