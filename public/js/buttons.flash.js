...
(function (g) {
    "function" === typeof define && define.amd
        ? define(["jquery", "datatables.net", "datatables.net-buttons"], function (q) {
    ...
    function t(a, b, c) {
        ...
        c &&
            (c.attr && g(d).attr(c.attr),
            c.children &&
                g.each(c.children, function (f, e) {
                    d.appendChild(e);
                }),
            ...
            if (g.isPlainObject(c)) N(c);
                ...
                if (G) {
                    ...
                    for (f = d.attributes.length - 1; 0 <= f; f--) {
                        ...
                        -1 !== n.indexOf(":") && (e.push({ name: n, value: k }), d.removeAttribute(n));
                    }
                    f = 0;
                    for (n = e.length; f < n; f++) (k = c.createAttribute(e[f].name.replace(":", "_dt_b_namespace_token_"))), (k.value = e[f].value), d.setAttributeNode(k);
                }
    ...
    m.hasFlash = function () {
        try {
            ...
            if (navigator.mimeTypes && navigator.mimeTypes["application/x-shockwave-flash"] !== z && navigator.mimeTypes["application/x-shockwave-flash"].enabledPlugin) return !0;
        }
        return !1;
    };
    ...
    var O = function (a, b) {
        ...
        Q = function (a, b) {
            ...
            var d = b.fieldBoundary,
                ...
                E = b.header ? k(a.header) + c : "";
            b = b.footer && a.footer ? c + k(a.footer) : "";
            for (var C = [], p = 0, v = a.body.length; p < v; p++) C.push(k(a.body[p]));
            return { str: E + C.join(c) + b, rows: C.length };
        },
        I = {
            available: function () {
                return m.hasFlash();
        ...
        J = "";
    J =
        "undefined" === typeof q.XMLSerializer
            ? new (function () {
    ...
    w.Buttons.swfPath = "//cdn.datatables.net/buttons/" + w.Buttons.version + "/swf/flashExport.swf";
    ...
    w.ext.buttons.copyFlash = g.extend({}, I, {
        ...
        text: function (a) {
            return a.i18n("buttons.copy", "Copiar");
        },
        action: function (a, b, c, d) {
            if (d._fromFlash) {
                ...
                c.messageTop && (f = c.messageTop + e + e + f);
    ...
    w.ext.buttons.excelFlash = g.extend({}, I, {
        ...
        action: function (a, b, c, d) {
            ...
            c = {
                _rels: { ".rels": g.parseXML(A["_rels/.rels"]) },
                xl: { _rels: { "workbook.xml.rels": g.parseXML(A["xl/_rels/workbook.xml.rels"]) }, "workbook.xml": g.parseXML(A["xl/workbook.xml"]), "styles.xml": g.parseXML(A["xl/styles.xml"]), worksheets: { "sheet1.xml": e } },
            ...
            var k = b.buttons.exportData(d.exportOptions),
                ...
                p = function (h) {
                    ...
                    for (var l = 0, F = h.length; l < F; l++) {
                        var K = M(l) + "" + E,
                            y = null;
                        if (null === h[l] || h[l] === z || "" === h[l])
                            if (!0 === d.createEmptyCells) h[l] = "";
                            else continue;
                        h[l] = h[l].trim();
                        for (var L = 0, U = R.length; L < U; L++) {
                            var D = R[L];
                            if (h[l].match && !h[l].match(/^0\d+/) && h[l].match(D.match)) {
                                y = h[l].replace(/[^\d\.\-]/g, "");
                                D.fmt && (y = D.fmt(y));
                                y = t(e, "c", { attr: { r: K, s: D.style }, children: [t(e, "v", { text: y })] });
                                break;
                            }
                        }
                        y ||
                            ("number" === typeof h[l] || (h[l].match && h[l].match(/^-?\d+(\.\d+)?$/) && !h[l].match(/^0\d+/))
                                ? (y = t(e, "c", { attr: { t: "n", r: K }, children: [t(e, "v", { text: h[l] })] }))
                                : ((D = h[l].replace ? h[l].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "") : h[l]),
                                  (y = t(e, "c", { attr: { t: "inlineStr", r: K }, children: { row: t(e, "is", { children: { row: t(e, "t", { text: D }) } }) } }))));
                        C.appendChild(y);
                    }
                    n.appendChild(C);
                    f++;
            ...
            var v = function (h, l) {
                    ...
                    F[0].appendChild(t(e, "mergeCell", { attr: { ref: "A" + h + ":" + M(l) + h } }));
                    F.attr("count", F.attr("count") + 1);
                    g("row:eq(" + (h - 1) + ") c", e).attr("s", "51");
                },
                u = b.buttons.exportInfo(d);
            u.title && (p([u.title], f), v(f, k.header.length - 1));
            u.messageTop && (p([u.messageTop], f), v(f, k.header.length - 1));
            d.header && (p(k.header, f), g("row:last c", e).attr("s", "2"));
            for (var x = 0, B = k.body.length; x < B; x++) p(k.body[x], f);
            d.footer && k.footer && (p(k.footer, f), g("row:last c", e).attr("s", "2"));
            u.messageBottom && (p([u.messageBottom], f), v(f, k.header.length - 1));
            p = t(e, "cols");
            g("worksheet", e).prepend(p);
            v = 0;
            for (x = k.header.length; v < x; v++) p.appendChild(t(e, "col", { attr: { min: v + 1, max: v + 1, width: S(k, v), customWidth: 1 } }));
        ...
        action: function (a, b, c, d) {
            ...
            var f = b.buttons.exportInfo(d),
                ...
                n = b
                    ...
                    .indexes()
                    .map(function (k) {
                        return b.column(k).header().offsetWidth / e;
                    });
            a.setAction("pdf");
